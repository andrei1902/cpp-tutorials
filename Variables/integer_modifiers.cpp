...
int main(){
	signed int value1 {22}; // default behaviour
	int value2 {-23};
	unsigned int value3 {123456}; // only positive numbers

	std::cout << "value1 " << value1 << " " << sizeof(value1) << std::endl;
	std::cout << "value1 " << value2 << " " << sizeof(value2) << std::endl;
	std::cout << "value1 " << value3 << " " << sizeof(value3) << std::endl;
